...
#   persist the result: --out <dir> writes design.json + study-report.json + audit-log.json
cargo run -p entelechy-cli -- audit ./study-out   # re-verify the audit chain (exit!=0 if tampered)
